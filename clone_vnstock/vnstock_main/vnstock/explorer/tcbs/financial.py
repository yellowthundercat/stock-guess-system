...
class Finance:
    ...
    def __init__(self, symbol: str, report_type: Optional[str] = 'income_statement', 
        ...
        self.report_type = _FINANCIAL_REPORT_PERIOD_MAP.get(report_type)
    ...
    def _get_report(self, report_type: Optional[str] = 'balance_sheet', 
        ...
        effective_report_type = _FINANCIAL_REPORT_PERIOD_MAP.get(report_type, report_type) if report_type else self.report_type
        ...
        url = f'{_GRAPHQL_URL}/v1/finance/{self.symbol}/{effective_report_type}'
    ...
    def ratio(self, period: Optional[str] = 'quarter', dropna: Optional[bool] = True, 
        ...
        url = f'{_GRAPHQL_URL}/v1/finance/{self.symbol}/financialratio'
